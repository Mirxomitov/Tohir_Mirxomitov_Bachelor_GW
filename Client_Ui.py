...
"")
        ...
        self.Btn_DiaLeft = QtWidgets.QPushButton(Client)
        self.Btn_DiaLeft.setGeometry(QtCore.QRect(80, 470, 75, 30))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(10)
        self.Btn_DiaLeft.setFont(font)
        self.Btn_DiaLeft.setStyleSheet("")
        self.Btn_DiaLeft.setObjectName("Btn_DiaLeft")
        self.Btn_DiaDRight = QtWidgets.QPushButton(Client)
        self.Btn_DiaDRight.setGeometry(QtCore.QRect(300, 570, 75, 30))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(10)
        self.Btn_DiaDRight.setFont(font)
        self.Btn_DiaDRight.setStyleSheet("")
        self.Btn_DiaDRight.setObjectName("Btn_DiaDRight")
        self.Btn_DiaDLeft = QtWidgets.QPushButton(Client)
        self.Btn_DiaDLeft.setGeometry(QtCore.QRect(80, 570, 75, 30))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(10)
        self.Btn_DiaDLeft.setFont(font)
        self.Btn_DiaDLeft.setStyleSheet("")
        self.Btn_DiaDLeft.setObjectName("Btn_DiaDLeft")
        self.Btn_DiaRight = QtWidgets.QPushButton(Client)
        self.Btn_DiaRight.setGeometry(QtCore.QRect(300, 470, 75, 30))
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(10)
        self.Btn_DiaRight.setFont(font)
        self.Btn_DiaRight.setStyleSheet("")
        self.Btn_DiaRight.setObjectName("Btn_DiaRight")
        ...
        self.Btn_wheel = QtWidgets.QPushButton(self.layoutWidget)
        font = QtGui.QFont()
        font.setFamily("Malgun Gothic")
        font.setPointSize(9)
        self.Btn_wheel.setFont(font)
        self.Btn_wheel.setStyleSheet("")
        self.Btn_wheel.setObjectName("Btn_wheel")
        self.horizontalLayout.addWidget(self.Btn_wheel)
    ...
    def retranslateUi(self, Client):
        ...
        self.checkBox_Led1.setText(_translate("Client", "Светодиод 1"))
        self.label_Servo2.setText(_translate("Client", "0"))
        self.checkBox_Led2.setText(_translate("Client", "Светодиод 2"))
        self.checkBox_Led3.setText(_translate("Client", "Светодиод 3"))
        self.checkBox_Led4.setText(_translate("Client", "Светодиод 4"))
        self.checkBox_Led5.setText(_translate("Client", "Светодиод 5"))
        self.checkBox_Led6.setText(_translate("Client", "Светодиод 6"))
        self.checkBox_Led7.setText(_translate("Client", "Светодиод 7"))
        self.checkBox_Led8.setText(_translate("Client", "Светодиод 8"))
        self.label_Servo1.setText(_translate("Client", "90"))
        self.checkBox_Led_Mode2.setText(_translate("Client", "Режим Светодиода 2"))
        self.checkBox_Led_Mode3.setText(_translate("Client", "Режим Светодиода 3"))
        self.checkBox_Led_Mode4.setText(_translate("Client", "Режим Светодиода 4"))
        self.checkBox_Led_Mode1.setText(_translate("Client", "Режим Светодиода 1"))
        ...
        self.R.setText(_translate("Client", "Красный"))
        self.G.setText(_translate("Client", "Зеленый"))
        self.B.setText(_translate("Client", "Синий"))
        ...
        # self.Btn_DiaLeft.setText(_translate("Client", "↖"))
        # self.Btn_DiaDRight.setText(_translate("Client", "↘"))
        # self.Btn_DiaDLeft.setText(_translate("Client", "↙"))
        # self.Btn_DiaRight.setText(_translate("Client", "↗"))
        self.Btn_Move_Left.setText(_translate("Client", "Двигаться влево"))
        self.Btn_wheel.setText(_translate("Client", "Механические колеса"))
